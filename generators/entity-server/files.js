    ...
    server: [
        {
            ...
            templates: [
                ...
                {
                    file: 'package/web/rest/admin/EntityResource.java',
                    renameTo: generator => `${generator.packageFolder}/web/rest/admin/${generator.entityClass}Resource.java`
                }
            ]
        },
        {
            ...
            templates: [
                {
                    file: 'package/service/admin/dto/EntityCriteria.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/dto/${generator.entityClass}Criteria.java`
                },
                {
                    file: 'package/service/admin/EntityQueryService.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/${generator.entityClass}QueryService.java`
                }
            ]
        },
        {
        ...
        },
        {
            ...
            templates: [
                {
                    file: 'package/service/admin/EntityService.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/${generator.entityClass}Service.java`
                },
                {
                    file: 'package/service/admin/impl/EntityServiceImpl.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/impl/${generator.entityClass}ServiceImpl.java`
                }
            ]
        },
        {
        ...
        },
        {
            ...
            templates: [
                {
                    file: 'package/service/admin/dto/EntityDTO.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/dto/${generator.asDto(generator.entityClass)}.java`
                },
                {
                    file: 'package/service/admin/mapper/BaseEntityMapper.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/mapper/EntityMapper.java`
                },
                {
                    file: 'package/service/admin/mapper/EntityMapper.java',
                    renameTo: generator => `${generator.packageFolder}/service/admin/mapper/${generator.entityClass}Mapper.java`
                }
            ]
        }
    ],
    test: [
        {
            ...
            templates: [
                {
                    file: 'package/web/rest/admin/EntityResourceIT.java',
                    options: {
                        context: {
                            randexp,
                            _,
                    ...
                    renameTo: generator => `${generator.packageFolder}/web/rest/admin/${generator.entityClass}ResourceIT.java`
                }
            ]
        },
        {
